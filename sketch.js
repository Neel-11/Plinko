...
function draw() {
  ...
  if(gameState === "PLAY")
  {
    ...
    textSize(20);
    text("Press on any part and try to make your way. Do it well because you only have 5 chances", 180, 30);
  ...
  else if (gameState === "END")
  {
    ...
    textSize(20);
    text("Well done. If you want to play again press space",535,400);
    if(keyIsDown(32))
    {
      gameState="PLAY";
      turn = 0;
